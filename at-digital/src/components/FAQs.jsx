...
function FAQs() {
  return (
      ...
      >
        ...
        <div className=" ">
          <div
            className="border rounded-[7px] bg-[#FAF8FF] text-[20px]
                          xs:p-[20px] xs:m-[20px]  "
          >
          ...
          <div
            className="border rounded-[7px] p-[16px] bg-[#FAF8FF] 
                          xs:mx-[20px]"
          >
            <div className="flex justify-between ">
              <p className="font-font-medium text-black text-[20px] leading-[28px]">
                Lorem ipsum dolor sit amet consectetur. Tortor scelerisque
                integer?
              </p>
              <span className="text-black font-semibold h-[14px] w-[14px] ">
                +
              </span>
            </div>
          </div>
          ...
          >
            <div className="flex justify-between">
              <p className=" text-black font-medium leading-[28px] text-[20px]  ">
